...
import com.techmania.grocify.databinding.FragmentOrderDetailBinding
...
class OrderDetailFragment : Fragment() {
    ...
    private suspend fun getOrderedProducts() {
        viewModel.getOrderProducts(orderId).collect{cartList ->
    ...
    private fun settingStatus() {
        val statusToViews = mapOf(
            ...
            2 to listOf(binding.iv1, binding.iv2, binding.view1, binding.view2),
            3 to listOf(binding.iv1, binding.iv2, binding.iv3, binding.view2, binding.iv4, binding.view3)
        )

...
import com.techmania.grocify.databinding.ItemViewOrdersBinding
import com.techmania.grocify.models.OrderedItems
        ...
        holder.binding.apply {
            ...
            when(order.itemStatus){
                0-> {
                    ...
                    tvOrderStatus.backgroundTintList = ContextCompat.getColorStateList(context , R.color.skyBlue)
                ...
                tvOrderStatus.backgroundTintList = ContextCompat.getColorStateList(context , R.color.grayish_blue)
